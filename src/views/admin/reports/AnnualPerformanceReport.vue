<template>
    <section class="container-fluid my-4">
        <h4 class="my-4">Relatório Desempenho <strong>Anual</strong></h4>
    ...
    methods: {
        ...
        async generateReport() {
            ...
            try {
                ...
                await api
                    .get(`/exports/annual-performance-report/${this.team_id}`, {
                        responseType: "blob",
                    })
                    .then((response) => {
                        ...
                        a.download = `RelatorioDesempenhoAnual_${this.year} - ` + teamName[0].name.toUpperCase();
                        a.click();
